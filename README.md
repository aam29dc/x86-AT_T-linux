...
`main.s` uses our linked `list.s`, our list uses our `alloc.s` and `print.s` library. our allocator and print libraries are written using only system interrupts. No external libraries are used for the project. <br>
